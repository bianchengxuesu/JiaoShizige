...
<div class="navbar navbar-inverse" id="home">
 ...
 <div class="container ">
  ...
  <script language="javaScript"> 
   ...
   <a href="../../system/index">首页</a> - <a href="https://aacsb.ustc.edu.cn/tjut/logout.asp">退出</a></div>
  <div>
...
<nav class="navbar navbar-default">
    ...
    <div class="navbar-header" style="text-align:right;">
	  <button type="button" class="navbar-toggle collapsed navbar-toggle_col" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false">
        ...
        <span class="navbar-brand"><b>社会兼职</b></span>
    </div>
    <div>
 ...
 <button type="submit" class="btn btn-default"><span style="font-size:12px;"><span class="glyphicon glyphicon-search"></span></span> 搜索</button>
  ...
  <span class="pull-right">
   ...
   <span class="btn-group">
    ...
    -->
    <a class="btn btn-default mt-3 mb-3 mr-5" href="/JiaoShizige/zhiligongxian/shehuijianzhi/download.do" onclick="if(confirm(&#39;导入\导出Excel数据系统需要花大量的时间来处理，请耐心等待勿刷新或关闭页面，以免造成浏览器崩溃！&#39;))window.location=&#39;DevoteExcels.asp?t=Devotes&amp;m=1&#39;">导入模板下载</a>
...
<div class="container" style="margin-top: 0px;">
 <div class="mt-10" style="min-height:280px;">
   <form method="post" id="LeadAACSB">
    <table class="table">
     <thead>
      <tr class="active">
	   ...
	   <th class="co-w100 co-hide-800">兼职类别</th>
	...
	<c:forEach items="${socialList}" var="L">
      <tr onmouseover="this.bgColor=&#39;f9f9f9&#39;;this.style.cursor=&#39;hand&#39;" onmouseout="this.bgColor=&#39;ffffff&#39;">
       ...
       <td onclick="TestBlack(&#39;set1-18&#39;);" class=""><span data-toggle="tooltip" data-placement="top" title="" data-original-title="第2行，点击此处展开详细信息 ↓">${L.service_name}</span> </td>
