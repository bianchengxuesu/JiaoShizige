 ...
 <button type="submit" class="btn btn-default"><span style="font-size:12px;"><span class="glyphicon glyphicon-search"></span></span> 搜索</button>
  ...
  <span class="pull-right">
   ...
   <span class="btn-group">
	...
	<a class="btn btn-success mt-3 mb-3" href="jiaoxuehuojiangtianjia" name="DevotesAdd.asp?m=1&amp;hs="><span class="glyphicon glyphicon-plus"></span> 添加</a>
...
<div class="container" style="margin-top: 0px;">
 <div class="mt-10" style="min-height:280px;">
		 ...
		 <form method="POST"  enctype="multipart/form-data" id="form1" action="/JiaoShizige/zhiligongxian/jiaoxuehuojiang/form.do">  
