...
<nav class="navbar navbar-default">
    ...
    <div class="navbar-header" style="text-align:right;">
	  <button type="button" class="navbar-toggle collapsed navbar-toggle_col" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false">
        ...
        <span class="navbar-brand"><b>教学获奖</b></span>
    </div>
    <div>
...
<form name="form1" action="/JiaoShizige/zhiligongxian/jiaoxuehuojiang/jiaoxuehuojiang" method="post">
 <div class="pull-left mt-3 mb-3">
  <input type="text" class="form-control search_input" id="KeyWord" name="text" placeholder="请输入搜索内容" required="">
 </div>
 ...
 <button type="submit" class="btn btn-default"><span style="font-size:12px;"><span class="glyphicon glyphicon-search"></span></span> 搜索</button>
  ...
  <span class="pull-right">
   ...
   <span class="btn-group">
	...
	<a class="btn btn-default mt-3 mb-3 mr-5" href="/JiaoShizige/zhiligongxian/jiaoxuehuojiang/download.do" onclick="if(confirm(&#39;导入\导出Excel数据系统需要花大量的时间来处理，请耐心等待勿刷新或关闭页面，以免造成浏览器崩溃！&#39;))window.location=&#39;DevoteExcels.asp?t=Devotes&amp;m=1&#39;">导入模板下载</a>
	...
	<a class="btn btn-success mt-3 mb-3" href="jiaoxuehuojiangtianjia" name="DevotesAdd.asp?m=1&amp;hs="><span class="glyphicon glyphicon-plus"></span> 导入</a>
   ...
   <form method="post" id="LeadAACSB">
    <table class="table">
     <thead>
      <tr class="active">
	   ...
	   <th class="">获奖名称</th>
       <th class="co-w100 co-hide-800">教师名称</th>
       
	   <th class="co-w80 co-hide-800">系别</th>
	   
	   <th class="co-w100 co-hide-800">获奖级别</th>
	   
	   <th class="co-w100">获奖时间</th>
	   
	   <th class="co-w80">状态</th>
	   
	   <th class="co-w80">管理</th>
	...
	<c:forEach items="${List}" var="L">
      <tr onmouseover="this.bgColor=&#39;f9f9f9&#39;;this.style.cursor=&#39;hand&#39;" onmouseout="this.bgColor=&#39;ffffff&#39;">
	   ...
	   <td class="co-w35 co-hide-768"><input name="delID" disabled="disabled" type="checkbox" id="se" class="bigbox" value="18"></td>
	   
       <td onclick="TestBlack(&#39;set1-18&#39;);" class=""><span data-toggle="tooltip" data-placement="top" title="" data-original-title="第2行，点击此处展开详细信息 ↓">${L.award_name}</span> </td>
       <!--<td class="co-50 co-hide-570"><a target="_blank" href="../qikanwenzhang/down/${L.award_id}"><img borer="0" src="../../resources/admin/login/images/download.gif"></a></td>-->
       
       <td class="co-w60 co-hide-800">${L.teacher_name}</td>
       
       <td class="co-w60 co-hide-800">${L.department}</td>
       
       <td class="co-w80 co-hide-800">${L.award_level}</td>
       
	   <td class="co-w60 co-hide-800">${L.date}</td>
	  
       <td class="co-w60"><font color="green">已审</font></td>
	   <td class="co-w50 text-center"><a class="btn btn-default btn-bin" onclick="TestBlack(&#39;set-18&#39;);"><span class="glyphicon glyphicon-cog" title="点击展开进行查看和管理"></span></a></td>
	   
      </tr>
	  <tr>
       <td colspan="20" style="padding:0;border-top:none;">
	    <div id="set-18" style="display:none;">
		<span class="pull-left ml-10 mt-10 co-chk">
		 <input name="delID" disabled="disabled" type="checkbox" id="se" class="bigbox" value="18">
		</span>
	    <span class="pull-right">
		 
         <a class="btn btn-default mt-5 mb-5 mr-5" name="Devotes.asp?m=1&amp;checked=yes&amp;DeID=18&amp;check=0&amp;h=" onclick="getvalue(this.name)">取消审核</a>
         
		 <a class="btn btn-default mt-5 mb-5 mr-5" name="DevotesTeacher.asp?m=1&amp;DeID=18&amp;hs=" onclick="getvalue(this.name)">作者管理</a>
		 
         <a class="btn btn-default mt-5 mb-5 mr-5" name="DevotesEdit.asp?m=1&amp;DeID=18&amp;hs=" onclick="getvalue(this.name)">编辑</a>
		 
        </span>
		<div style="clear:both;"></div>
		</div>
        <div id="set1-18" style="display:none;" class="admin-info">
		...
		<div class="mb-5 pl-10">
         <font color="red">作者：</font>李四&nbsp;&nbsp;&nbsp;<font color="red">通讯作者：</font>李四
		</div>
		<div class="mb-5 pl-10">
         <font color="red">添加时间：</font>2019/10/29 14:24:10&nbsp;&nbsp;&nbsp;<font color="red">最终审核人：</font>管理员
		</div>
		</div>
	   </td>
      </tr>
	 ...
	 <input name="aurl" type="hidden" value="http://aacsb.ustc.edu.cn/tjut/Devotes.asp?m=1">
	</form>
	<div style="clear:both;"></div>
 </div>
</div>
