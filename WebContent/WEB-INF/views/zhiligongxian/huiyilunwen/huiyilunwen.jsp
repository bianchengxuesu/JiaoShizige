<%@ page language="java" contentType="text/html; charset=utf-8"
    pageEncoding="utf-8"%>
<!DOCTYPE html>
<!-- saved from url=(0046)https://aacsb.ustc.edu.cn/tjut/Devotes.asp?m=2 -->
...
<div class="navbar navbar-inverse" id="home">
 ...
 <div class="container ">
  ...
  </script> <a href="https://aacsb.ustc.edu.cn/tjut/index.html">首页</a> - <a href="https://aacsb.ustc.edu.cn/tjut/logout.asp">退出</a></div>
  <div style="clear:both;"></div>
  <div>
   <div style="float:left;margin:0px 0px 20px 0px;"><img src="../../resources/admin/login/images/aacsb_logo.png"></div>
 ...
 <div class="navbg">
  ...
  <div class="navbar-collapse collapse">
   <ul class="nav navbar-nav mainNav">
    <li><a href="https://aacsb.ustc.edu.cn/tjut/Devotes.asp?m=2#" class="dropdown-toggle" data-toggle="dropdown">我的信息<b class="caret"></b></a>
    ...
    <li><a href="https://aacsb.ustc.edu.cn/tjut/Devotes.asp?m=2#" class="dropdown-toggle" data-toggle="dropdown">系统管理<b class="caret"></b></a>
     <ul class="dropdown-menu">
	  
      <li><a href="https://aacsb.ustc.edu.cn/tjut/Setting.asp"><span class="glyphicon  glyphicon-cog font13"></span> 系统设置</a></li>
	...
	<li><a href="https://aacsb.ustc.edu.cn/tjut/Devotes.asp?m=2#" class="dropdown-toggle" data-toggle="dropdown">标准数据<b class="caret"></b></a>
	 <ul class="dropdown-menu">
    ...
    <li><a href="https://aacsb.ustc.edu.cn/tjut/Devotes.asp?m=2#" class="dropdown-toggle" data-toggle="dropdown">表格输出<b class="caret"></b></a>
	 <ul class="dropdown-menu">
    ...
    <li><a href="https://aacsb.ustc.edu.cn/tjut/Devotes.asp?m=2#" class="dropdown-toggle" data-toggle="dropdown">信息检索<b class="caret"></b></a>
	 <ul class="dropdown-menu">
...
<nav class="navbar navbar-default">
    ...
    <div class="navbar-header" style="text-align:right;">
	  <button type="button" class="navbar-toggle collapsed navbar-toggle_col" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false">
        ...
        <span class="navbar-brand"><b>会议论文</b></span>
    </div>
    <div>
...
<ul class="nav navbar-nav navbar-left">
 <li class="dropdown">
  <a href="https://aacsb.ustc.edu.cn/tjut/Devotes.asp?m=2#" class="dropdown-toggle font16" data-toggle="dropdown">栏目导航<b class="caret"></b>
  </a>
  
 <ul class="dropdown-menu dropdown-menu-col">
   <li><a href="https://aacsb.ustc.edu.cn/tjut/Devotes.asp?m=1">期刊文章</a></li><li><a href="https://aacsb.ustc.edu.cn/tjut/Devotes.asp?m=2">会议论文</a></li><li><a href="https://aacsb.ustc.edu.cn/tjut/Devotes.asp?m=3">会议演讲</a></li><li><a href="https://aacsb.ustc.edu.cn/tjut/Devotes.asp?m=4">专著</a></li><li><a href="https://aacsb.ustc.edu.cn/tjut/Devotes.asp?m=5">教材</a></li><li><a href="https://aacsb.ustc.edu.cn/tjut/Devotes.asp?m=6">标准/政策</a></li><li><a href="https://aacsb.ustc.edu.cn/tjut/Devotes.asp?m=7">教学获奖</a></li><li><a href="https://aacsb.ustc.edu.cn/tjut/Devotes.asp?m=8">科研获奖</a></li><li><a href="https://aacsb.ustc.edu.cn/tjut/Devotes.asp?m=9">案例</a></li><li><a href="https://aacsb.ustc.edu.cn/tjut/Devotes.asp?m=10">专利</a></li><li><a href="https://aacsb.ustc.edu.cn/tjut/Devotes.asp?m=11">项目</a></li><li><a href="https://aacsb.ustc.edu.cn/tjut/Devotes.asp?m=12">研究报告</a></li><li><a href="https://aacsb.ustc.edu.cn/tjut/Devotes.asp?m=13">社会任职</a></li><li><a href="https://aacsb.ustc.edu.cn/tjut/Devotes.asp?m=14">期刊任职</a></li><li><a href="https://aacsb.ustc.edu.cn/tjut/Devotes.asp?m=15">软件著作权</a></li>
 </ul>
...
-->
        <ul class="nav navbar-nav navbar-right">
		 ...
		 <li class="font16"><a href="https://aacsb.ustc.edu.cn/tjut/DevoteLog.asp?m=2">操作日志</a></li>
	     
		 <li class="active font15"><a onclick="getvalue(this.name)" name="Devotes.asp?m=2&amp;h=">全部数据</a></li>
		 <li class=" font15"><a onclick="getvalue(this.name)" name="Devotes.asp?m=2&amp;isme=ok&amp;h=">只看自己</a></li>
...
<div class="container">
 <div class="text-center mb-5">
  <span>
   <span class="">
   <a class="btn btn-default font16 mr-5 mb-5" disabled="" onclick="getvalue(this.name)" name="Devotes.asp?m=2&amp;h=">全部</a>
   ...
   <ul class="dropdown-menu" role="menu">
	...
	<li><a onclick="getvalue(this.name)" name="Devotes.asp?m=2&amp;h=">全部</a></li>
    <li><a onclick="getvalue(this.name)" name="Devotes.asp?m=2&amp;Schoolsd=0&amp;h=">在职</a></li>
	<li><a onclick="getvalue(this.name)" name="Devotes.asp?m=2&amp;Schoolsd=1&amp;h=">兼职</a></li>
    <li><a onclick="getvalue(this.name)" name="Devotes.asp?m=2&amp;Schoolsd=8&amp;h=">返聘</a></li>
	<li><a onclick="getvalue(this.name)" name="Devotes.asp?m=2&amp;Schoolsd=7&amp;h=">已退休</a></li>
	<li><a onclick="getvalue(this.name)" name="Devotes.asp?m=2&amp;Schoolsd=4&amp;h=">已离职</a></li>
	
	<li class="divider"></li>
	<li class="dropdown-header">按领域类别</li>
	<li><a onclick="getvalue(this.name)" name="Devotes.asp?m=2&amp;h=">全部</a></li>
    <li><a onclick="getvalue(this.name)" name="Devotes.asp?m=2&amp;Ptypes=1&amp;h=">基础</a></li>
    <li><a onclick="getvalue(this.name)" name="Devotes.asp?m=2&amp;Ptypes=2&amp;h=">应用</a></li>
	<li><a onclick="getvalue(this.name)" name="Devotes.asp?m=2&amp;Ptypes=3&amp;h=">教学</a></li>
   </ul>
   </span>
   ...
   <ul class="dropdown-menu" role="menu">
    <li><a onclick="getvalue(this.name)" name="Devotes.asp?m=2&amp;h=">全部</a></li>
    <li><a onclick="getvalue(this.name)" name="Devotes.asp?m=2&amp;sort=dename&amp;h=">按名称</a></li>
	<li><a onclick="getvalue(this.name)" name="Devotes.asp?m=2&amp;sort=dedate&amp;h=">按发表日期</a></li>
    <li><a onclick="getvalue(this.name)" name="Devotes.asp?m=2&amp;sort=id&amp;h=">按最新添加</a></li>
	<li><a onclick="getvalue(this.name)" name="Devotes.asp?m=2&amp;sort=updates&amp;h=">按最后编辑</a></li>
...
<form name="form1" action="https://aacsb.ustc.edu.cn/tjut/Devotes.asp?m=2" method="post">
  ...
  <span class="pull-right">
   ...
   <span class="btn-group">
    <button type="button" class="btn btn-default mt-3 mb-3 mr-5 dropdown-toggle" data-toggle="dropdown">审核<span class="caret"></span></button>
     <ul class="dropdown-menu" role="menu">
      <li><a onclick="if(confirm(&#39;一键审核或未审为危险操作，确定吗？！&#39;))window.location=&#39;Devotes.asp?m=2&amp;one_checked=yes&amp;check=1&#39;">一键审核</a></li>
	  <li><a onclick="if(confirm(&#39;一键审核或未审为危险操作，确定吗？！&#39;))window.location=&#39;Devotes.asp?m=2&amp;one_checked=yes&amp;check=0&#39;">一键未审</a></li>
     </ul>
   </span>
   
	<a class="btn btn-default mt-3 mb-3 mr-5" onclick="if(confirm(&#39;导出Excel数据系统需要花大量的时间来处理，请耐心等待勿刷新或关闭页面，以免造成浏览器崩溃！&#39;))window.location=&#39;DevoteExcels.asp?t=Devotes&amp;m=2&#39;"><span class="glyphicon glyphicon-export"></span> 导出</a>
	...
	<a class="btn btn-success mt-3 mb-3" onclick="getvalue(this.name)" href="javascript:void(0)" name="DevotesAdd.asp?m=2&amp;hs="><span class="glyphicon glyphicon-plus"></span> 添加</a>
    ...
    <table class="table">
     <thead>
      <tr class="active">
	   ...
	   <th class="">会议论文信息</th>
       <th class="co-w50 co-hide-570">文档</th>
       
	   <th class="co-w60 co-hide-800">领域</th>
	   
	   <th class="co-w60">状态</th>
	   <th class="co-w50">管理</th>
     ...
     <tbody>
      ...
      <tr onmouseover="this.bgColor=&#39;f9f9f9&#39;;this.style.cursor=&#39;hand&#39;" onmouseout="this.bgColor=&#39;ffffff&#39;">
	   
	   <td class="co-w35 co-hide-768"><input name="delID" disabled="disabled" type="checkbox" id="se" class="bigbox" value="9"></td>
	   
       <td onclick="TestBlack(&#39;set1-9&#39;);" class=""><span data-toggle="tooltip" data-placement="top" title="" data-original-title="第1行，点击此处展开详细信息 ↓">第二十九届中国控制会议论文,  第二十九届中国控制会议论文集 , 2015</span> </td>
       <td class="co-50 co-hide-570"></td>
       
	   <td class="co-w60 co-hide-800">基础</td>
	   
       <td class="co-w60"><font color="green">已审</font></td>
	   <td class="co-w50 text-center"><a class="btn btn-default btn-bin" onclick="TestBlack(&#39;set-9&#39;);"><span class="glyphicon glyphicon-cog" title="点击展开进行查看和管理"></span></a></td>
	   
      </tr>
	  <tr>
       <td colspan="20" style="padding:0;border-top:none;">
	    <div id="set-9" style="display:none;">
		<span class="pull-left ml-10 mt-10 co-chk">
		 <input name="delID" disabled="disabled" type="checkbox" id="se" class="bigbox" value="9">
		</span>
	    <span class="pull-right">
		 
         <a class="btn btn-default mt-5 mb-5 mr-5" name="Devotes.asp?m=2&amp;checked=yes&amp;DeID=9&amp;check=0&amp;h=" onclick="getvalue(this.name)">取消审核</a>
         
		 <a class="btn btn-default mt-5 mb-5 mr-5" name="DevotesTeacher.asp?m=2&amp;DeID=9&amp;hs=" onclick="getvalue(this.name)">作者管理</a>
		 
         <a class="btn btn-default mt-5 mb-5 mr-5" name="DevotesEdit.asp?m=2&amp;DeID=9&amp;hs=" onclick="getvalue(this.name)">编辑</a>
		 
        </span>
		<div style="clear:both;"></div>
		</div>
        <div id="set1-9" style="display:none;" class="admin-info">
         
		<div class="mb-5 pl-10">
         <font color="red">作者：</font>李三、李四
		</div>
		<div class="mb-5 pl-10">
         <font color="red">添加人：</font>管理员&nbsp;&nbsp;&nbsp;<font color="red">添加时间：</font>2018/3/8 11:07:01&nbsp;&nbsp;&nbsp;<font color="red">最终审核人：</font>管理员
		</div>
		</div>
	   </td>
      </tr>
	 ...
	 <input name="aurl" type="hidden" value="http://aacsb.ustc.edu.cn/tjut/Devotes.asp?m=2">
	</form>
	<div style="clear:both;"></div>
 </div>
</div>
 ...
 <div class="modal-dialog">
  <div class="modal-content">
   ...
   <div class="modal-footer">
    ...
    <input type="hidden" name="Demenu" value="2">
	<input type="hidden" name="aurl" value="http://aacsb.ustc.edu.cn/tjut/Devotes.asp?m=2">
...
<div class="modal fade" id="showmsg" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
 ...
 <div class="aacsb_footer">
	<p class="info">系统仅支持Chrome、Firefox、Edge等浏览器<br>Copyright © 2013-2021，&nbsp;<a href="https://aacsb.ustc.edu.cn/tjut/Copyright.asp">信息系统版权说明和技术支持</a>&nbsp; v3.1.210411, 页面执行时间：46.88毫秒
 </p></div>
</section>
