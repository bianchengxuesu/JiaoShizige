...
<nav class="navbar navbar-default">
    ...
    <div class="navbar-header" style="text-align:right;">
	  <button type="button" class="navbar-toggle collapsed navbar-toggle_col" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false">
        ...
        <span class="navbar-brand"><b>专利</b></span>
    </div>
    <div>
...
<!-- 	<a class="btn btn-default mt-3 mb-3 mr-5" href="tianjia" onclick="if(confirm(&#39;导入\导出Excel数据系统需要花大量的时间来处理，请耐心等待勿刷新或关闭页面，以免造成浏览器崩溃！&#39;))window.location=&#39;DevoteExcels.asp?t=Devotes&amp;m=1&#39;"><span class="glyphicon glyphicon-export"></span> 导入</a>
 -->
  <a class="btn btn-default mt-3 mb-3 mr-5" href="/JiaoShizige/zhiligongxian/zhuanli/download.do" onclick="if(confirm(&#39;导入\导出Excel数据系统需要花大量的时间来处理，请耐心等待勿刷新或关闭页面，以免造成浏览器崩溃！&#39;))window.location=&#39;DevoteExcels.asp?t=Devotes&amp;m=1&#39;">导入模板下载</a>
...
<div class="container" style="margin-top: 0px;">
 <div class="mt-10" style="min-height:280px;">
   <form method="post" id="LeadAACSB">
    <table class="table">
     <thead>
      <tr class="active">
	   ...
	   <th class="">专利名称</th>
       <th class="co-w100 co-hide-800">持有人名称</th>
	   
	   <th class="co-w100 co-hide-800">专利号</th>
	...
	<c:forEach items="${patentList}" var="L">
      <tr onmouseover="this.bgColor=&#39;f9f9f9&#39;;this.style.cursor=&#39;hand&#39;" onmouseout="this.bgColor=&#39;ffffff&#39;">
       ...
       <td onclick="TestBlack(&#39;set1-18&#39;);" class=""><span data-toggle="tooltip" data-placement="top" title="" data-original-title="第2行，点击此处展开详细信息 ↓">${L.patent_name}</span> </td>
       
       <td class="co-w60 co-hide-800">${L.holder}</td>
       
       <td class="co-w60 co-hide-800">${L.apply_number}</td>
