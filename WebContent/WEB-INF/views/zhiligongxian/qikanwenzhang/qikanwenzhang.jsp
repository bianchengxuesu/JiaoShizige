...
<nav class="navbar navbar-default">
    ...
    <div class="navbar-header" style="text-align:right;">
	  <button type="button" class="navbar-toggle collapsed navbar-toggle_col" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false">
        ...
        <span class="navbar-brand"><b>期刊文章</b></span>
    </div>
    <div>
 ...
 <button type="submit" class="btn btn-default"><span style="font-size:12px;"><span class="glyphicon glyphicon-search"></span></span> 搜索</button>
  ...
  <span class="pull-right">
   ...
   <span class="btn-group">
	...
	<a class="btn btn-default mt-3 mb-3 mr-5" onclick="if(confirm(&#39;导出Excel数据系统需要花大量的时间来处理，请耐心等待勿刷新或关闭页面，以免造成浏览器崩溃！&#39;))window.location=&#39;DevoteExcels.asp?t=Devotes&amp;m=1&#39;"><span class="glyphicon glyphicon-export"></span> 导出</a>
	...
	<a class="btn btn-success mt-3 mb-3" onclick="getvalue(this.name)" href="qikanwenzhangtianjia" name="DevotesAdd.asp?m=1&amp;hs="><span class="glyphicon glyphicon-plus"></span> 添加</a>
   ...
   <form method="post" id="LeadAACSB">
    <table class="table">
     <thead>
      <tr class="active">
	   ...
	   <th class="co-w80 co-hide-1024 text-center">院定级别</th>
	...
	<c:forEach items="${List}" var="L">
      <tr onmouseover="this.bgColor=&#39;f9f9f9&#39;;this.style.cursor=&#39;hand&#39;" onmouseout="this.bgColor=&#39;ffffff&#39;">
       ...
       <td onclick="TestBlack(&#39;set1-18&#39;);" class=""><span data-toggle="tooltip" data-placement="top" title="" data-original-title="第2行，点击此处展开详细信息 ↓">${L.dename}</span> </td>
       <td class="co-50 co-hide-570"><a target="_blank" href="../qikanwenzhang/down/${L.pername}"><img borer="0" src="../../resources/admin/login/images/download.gif"></a></td>
       
       <td class="co-w80 co-hide-1024 text-center">
	   D
	   </td>
