...
$("#rid").val(ID);
var r1=$(obj).parent().find('div')[0];
var sp1	=$(r1).text();
$("#sp1").val(sp1);	
var r2=$(obj).parent().find('div')[1];
var sp2=$(r2).text();
$("#sp2").val(sp2);
var r3=$(obj).parent().find('div')[2];
var sp3=$(r3).text();
$("#sp3").val(sp3);
var r4=$(obj).parent().find('div')[3];
var sp4=$(r4).html();
KindEditor.html("#sp4",sp4); 
}
 </script>
 ...
 <div class="navbg">
  ...
  <div class="navbar-collapse collapse">
   <ul class="nav navbar-nav mainNav">
    <li><a href="https://aacsb.ustc.edu.cn/tjut/Specialty.asp#" class="dropdown-toggle" data-toggle="dropdown">我的信息<b class="caret"></b></a>
    ...
    <li><a href="https://aacsb.ustc.edu.cn/tjut/Specialty.asp#" class="dropdown-toggle" data-toggle="dropdown">系统管理<b class="caret"></b></a>
     <ul class="dropdown-menu">
	...
	<li><a href="https://aacsb.ustc.edu.cn/tjut/Specialty.asp#" class="dropdown-toggle" data-toggle="dropdown">标准数据<b class="caret"></b></a>
	 <ul class="dropdown-menu">
	...
	<li><a href="https://aacsb.ustc.edu.cn/tjut/Specialty.asp#" class="dropdown-toggle" data-toggle="dropdown">智力贡献<b class="caret"></b></a>
	 <ul class="dropdown-menu">
    ...
    <li><a href="https://aacsb.ustc.edu.cn/tjut/Specialty.asp#" class="dropdown-toggle" data-toggle="dropdown">表格输出<b class="caret"></b></a>
	 <ul class="dropdown-menu">
    ...
    <li><a href="https://aacsb.ustc.edu.cn/tjut/Specialty.asp#" class="dropdown-toggle" data-toggle="dropdown">信息检索<b class="caret"></b></a>
	 <ul class="dropdown-menu">
...
<nav class="navbar navbar-default">
    ...
    <div class="navbar-header" style="text-align:right;">
	  <button type="button" class="navbar-toggle collapsed navbar-toggle_col" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false">
        ...
        <span class="navbar-brand"><b>专业方向</b></span>
    </div>
    <div>
...
<ul class="nav navbar-nav navbar-left">
 <li class="dropdown">
  <a href="https://aacsb.ustc.edu.cn/tjut/Specialty.asp#" class="dropdown-toggle font16" data-toggle="dropdown">栏目导航<b class="caret"></b>
  </a>
...
--><ul class="nav navbar-nav navbar-right">
 ...
 <li class="active font15"><a href="specialty">专业</a></li>
...
<form name="form1" action="https://aacsb.ustc.edu.cn/tjut/Specialty.asp" method="post">
 ...
 <button type="submit" class="btn btn-default"><span style="font-size:12px;"><span class="glyphicon glyphicon-search"></span></span> 搜索</button>
  ...
  <span class="pull-right">
   ...
   <button type="submit" name="action" form="deleteSpecialty" onclick="return check();" class="btn btn-danger mt-3 mb-3 mr-5 font16"><span class="glyphicon glyphicon-trash"></span> 删除</button>
   <a class="btn btn-success mt-3 mb-3 font16" data-toggle="modal" data-target="#myadd" href="javascript:void(0)"><span class="glyphicon glyphicon-plus"></span> 添加</a>
...
<div class="container">
 <div class="mt-10" style="min-height:130px;">
   <form id="deleteSpecialty" action="deleteSpecialty.do" method="post">
    <table class="table">
     <thead>
      <tr class="active">
       <th class="co-w35">sel.</th>
	   <th class="co-w200">中文名称</th>
	   <th class="co-hide-900">英文名称</th>
	   <th class="co-w100 co-hide-550">简称</th>
	   <th class="co-w80 co-hide-640">人数</th>
	   <th class="co-w60">排序</th>
     ...
     <c:forEach items="${ps.list}" var="L">
      <tr onmouseover="this.bgColor=&#39;f9f9f9&#39;;this.style.cursor=&#39;hand&#39;" onmouseout="this.bgColor=&#39;ffffff&#39;" data-toggle="tooltip" data-placement="top" title="" data-original-title="第1行">
	   <td class="co-w35"><input id="delid" name="delid" type="checkbox" class="bigbox" value="${L.spid}"></td>
       <td class="co-w200">${L.chineseName}</td>
	   <td class="co-hide-900">${L.englishName}</td>
	   <td class="co-w100 co-hide-550">${L.englishNames}</td>
	   <td class="co-w80 co-hide-640">${L.peopleNum}</td>
	   <td class="co-w60"><a class="mr-5" href="javascript:void(0)" name="Move.asp?run=ok&amp;t=Specialty&amp;ufiles=Specialty&amp;id=SpID&amp;at_ID=2&amp;OrderBy=1&amp;action=Up&amp;pa=1&amp;h=" onclick="getvalue(this.name)"><span class="glyphicon glyphicon-arrow-up"></span></a> <a href="javascript:void(0)" name="Move.asp?run=ok&amp;t=Specialty&amp;ufiles=Specialty&amp;id=SpID&amp;at_ID=2&amp;OrderBy=1&amp;action=Down&amp;pa=1&amp;h=" onclick="getvalue(this.name)"><span class="glyphicon glyphicon-arrow-down"></span></a></td>
	   <td class="co-w50"><a class="btn btn-default btn-bin" onclick="TestBlack(&#39;set-${L.spid}&#39;);"><span class="glyphicon glyphicon-cog" title="点击展开进行查看和管理"></span></a></td>
      </tr>
	  <tr id="set-${L.spid}" style="display:none;">
       <td colspan="20" style="padding:0">
	    <span class="pull-right">
		 <a class="btn btn-default mt-10 mb-10 mr-10" name="managelink?spid=${L.spid}&amp;h=" onclick="getvalue(this.name) ">人员管理</a>
         
		 <div class="hidden">${L.chineseName}</div>
		 <div class="hidden">${L.englishName}</div>
		 <div class="hidden">${L.englishNames}</div>
		 <div class="hidden"></div>
         <a class="btn btn-default mt-10 mb-10 mr-10" data-toggle="modal" data-target="#myedit" onclick="editAddress(2,this)">编辑</a>
	 ...
	 <input name="aurl" type="hidden" value="http://aacsb.ustc.edu.cn/tjut/Specialty.asp">
	</form>
 </div>
</div>
<div class="modal fade" id="myadd" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
		    <form action="addSpecialty.do" method="post" name="addSpecialty">
    ...
    <div class="controls">
     <div class="input-group">
	   <span class="input-group-addon" id="sizing-addon3"><div class="input-group-width80">中文名称</div></span>
		<input type="text" name="chineseName" class="form-control" placeholder="请输入专业中文名称" value="" required="">
	 </div>
	 <p class="help-block help-info"><font style="font-style:normal;font-size:13px;" color="red">*</font> 请输入专业中文名称</p>
	</div>
   </div>
   <div class="control-group">
    <div class="controls">
     <div class="input-group">
	   <span class="input-group-addon" id="sizing-addon3"><div class="input-group-width80">英文名称</div></span>
		<input type="text" name="englishName" class="form-control" placeholder="请输入专业英文名称" value="" required="">
	 </div>
	 <p class="help-block help-info"><font style="font-style:normal;font-size:13px;" color="red">*</font> 请输入专业英文名称</p>
	</div>
   </div>
   <div class="control-group">
    <div class="controls">
     <div class="input-group">
	   <span class="input-group-addon" id="sizing-addon3"><div class="input-group-width80">英文简称</div></span>
		<input type="text" name="englishNames" class="form-control" placeholder="请输入专业英文简称" value="" required="">
	 </div>
	 <p class="help-block help-info"><font style="font-style:normal;font-size:13px;" color="red">*</font> 请输入专业英文简称，比如GM</p>
	</div>
   </div>
			</div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
                <input name="addSpecialty" type="submit" class="btn btn-primary" value="完成提交">
            </div>
            </form>
        </div>
    </div>
...
<div class="modal fade" id="myedit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="controls">
     <div class="input-group">
	   <span class="input-group-addon" id="sizing-addon3"><div class="input-group-width80">中文名称</div></span>
		<input type="text" name="chineseName" id="sp1" class="form-control" placeholder="请输入专业中文名称" value="" required="">
	 </div>
	 <p class="help-block help-info"><font style="font-style:normal;font-size:13px;" color="red">*</font> 请输入专业中文名称</p>
	</div>
   </div>
   <div class="control-group">
    <div class="controls">
     <div class="input-group">
	   <span class="input-group-addon" id="sizing-addon3"><div class="input-group-width80">英文名称</div></span>
		<input type="text" name="englishName" id="sp2" class="form-control" placeholder="请输入专业英文名称" value="" required="">
	 </div>
	 <p class="help-block help-info"><font style="font-style:normal;font-size:13px;" color="red">*</font> 请输入专业英文名称</p>
	</div>
   </div>
   <div class="control-group">
    <div class="controls">
     <div class="input-group">
	   <span class="input-group-addon" id="sizing-addon3"><div class="input-group-width80">英文简称</div></span>
		<input type="text" name="englishNames" id="sp3" class="form-control" placeholder="请输入专业英文简称" value="" required="">
	 </div>
	 <p class="help-block help-info"><font style="font-style:normal;font-size:13px;" color="red">*</font> 请输入专业英文简称，比如GM</p>
	</div>
   </div>
   <div style="clear:both;"></div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
				<input type="hidden" name="SpID" value="" id="rid">
                <input name="edit" type="submit" class="btn btn-primary" value=" 更新 ">
            </div>
            </form>
        </div>
    </div>
...
<div class="container mt-40">
 <div class="alert alert-info alert-dismissable">
  ...
  提示：专业排序将直接反映在与专业分类相关的检索或与Table-2表的输出格式中；关系设置对指定教师按学科方向进行分类；只有认证教师才能设置学科方向。
 </div>
</div>
<!-- 分页功能 -->
...
<ul class='pagination'>
	...
	<c:if test="${ps.pageNum != 1}">
		<li><a href="specialty?page=${ps.pageNum-1}" aria-label="Previous"><span aria-hidden='true'>&laquo;</span></a></li>
	</c:if>
	<c:forEach begin="1" end="${ps.pages}" var="pageNumber">
		<c:if test="${pageNumber == ps.pageNum}">
			<li class="active"><a href="specialty?page=${pageNumber}">${pageNumber}</a></li>
		</c:if>
		<c:if test="${pageNumber != ps.pageNum}">
			<li><a href="specialty?page=${pageNumber}">${pageNumber}</a></li>
		</c:if>
	</c:forEach>
	...
	<c:if test="${ps.pageNum != ps.lastPage}">
		<li><a href="specialty?page=${ps.pageNum+1}" aria-label="Next"><span aria-hidden='true'>&raquo;</span></a></li>
	</c:if>
	</c:if>
</ul>
</nav>
