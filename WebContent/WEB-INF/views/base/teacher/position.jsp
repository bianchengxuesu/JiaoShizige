 ...
 <div class="navbg">
  ...
  <div class="navbar-collapse collapse">
   <ul class="nav navbar-nav mainNav">
    <li><a href="https://aacsb.ustc.edu.cn/tjut/Position.asp#" class="dropdown-toggle" data-toggle="dropdown">我的信息<b class="caret"></b></a>
    ...
    <li><a href="https://aacsb.ustc.edu.cn/tjut/Position.asp#" class="dropdown-toggle" data-toggle="dropdown">系统管理<b class="caret"></b></a>
     <ul class="dropdown-menu">
	...
	<li><a href="https://aacsb.ustc.edu.cn/tjut/Position.asp#" class="dropdown-toggle" data-toggle="dropdown">标准数据<b class="caret"></b></a>
	 <ul class="dropdown-menu">
	...
	<li><a href="https://aacsb.ustc.edu.cn/tjut/Position.asp#" class="dropdown-toggle" data-toggle="dropdown">智力贡献<b class="caret"></b></a>
	 <ul class="dropdown-menu">
    ...
    <li><a href="https://aacsb.ustc.edu.cn/tjut/Position.asp#" class="dropdown-toggle" data-toggle="dropdown">表格输出<b class="caret"></b></a>
	 <ul class="dropdown-menu">
    ...
    <li><a href="https://aacsb.ustc.edu.cn/tjut/Position.asp#" class="dropdown-toggle" data-toggle="dropdown">信息检索<b class="caret"></b></a>
	 <ul class="dropdown-menu">
...
<nav class="navbar navbar-default">
    ...
    <div class="navbar-header" style="text-align:right;">
	  <button type="button" class="navbar-toggle collapsed navbar-toggle_col" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false">
        ...
        <span class="navbar-brand"><b>职务信息</b></span>
    </div>
    <div>
...
<ul class="nav navbar-nav navbar-left">
 <li class="dropdown">
  <a href="https://aacsb.ustc.edu.cn/tjut/Position.asp#" class="dropdown-toggle font16" data-toggle="dropdown">栏目导航<b class="caret"></b>
  </a>
...
--><ul class="nav navbar-nav navbar-right">
 ...
 <li class="active font15"><a href="position">职务</a></li>
...
<form name="form1" action="https://aacsb.ustc.edu.cn/tjut/Position.asp" method="post">
 ...
 <button type="submit" class="btn btn-default"><span style="font-size:12px;"><span class="glyphicon glyphicon-search"></span></span> 搜索</button>
  ...
  <span class="pull-right">
   ...
   <button type="submit" name="action" form="deletePosition" onclick="return check();" class="btn btn-danger mt-3 mb-3 mr-5 font16"><span class="glyphicon glyphicon-trash"></span> 删除</button>
...
<div class="container">
 <div class="mt-10" style="min-height:130px;">
   <form id="deletePosition" action="deletePosition.do" method="post" >
    <table class="table">
     <thead>
      <tr class="active">
	   ...
	   <th class="co-w180">中文名称</th>
	   <th class="co-hide-800">英文名称</th>
	   <th class="co-w80">人数</th>
     ...
     <c:forEach items="${ps.list}" var="L">
      <tr onmouseover="this.bgColor=&#39;f9f9f9&#39;;this.style.cursor=&#39;hand&#39;" onmouseout="this.bgColor=&#39;ffffff&#39;" data-toggle="tooltip" data-placement="top" title="" data-original-title="第1行">
	   ...
	   <td class="co-w35"><input id="delid" name="delid" type="checkbox" class="bigbox" value="${L.poid}"></td>
	   
       <td class="co-w180">${L.chineseName}</td>
	   <td class="co-hide-800">${L.englishName}</td>
	   <td class="co-w80">${L.peopleNum}</td>
	   <td class="co-w60"><a class="mr-5" href="javascript:void(0)" name="Move.asp?run=ok&amp;t=Position&amp;ufiles=Position&amp;id=PoID&amp;at_ID=1&amp;OrderBy=1&amp;action=Up&amp;pa=1&amp;h=" onclick="getvalue(this.name)"><span class="glyphicon glyphicon-arrow-up"></span></a> <a href="javascript:void(0)" name="Move.asp?run=ok&amp;t=Position&amp;ufiles=Position&amp;id=PoID&amp;at_ID=1&amp;OrderBy=1&amp;action=Down&amp;pa=1&amp;h=" onclick="getvalue(this.name)"><span class="glyphicon glyphicon-arrow-down"></span></a></td>
	   <td class="co-w50 text-center"><a class="btn btn-default btn-bin" onclick="TestBlack(&#39;set-${L.poid}&#39;);"><span class="glyphicon glyphicon-cog" title="点击展开进行查看和管理"></span></a></td>
      </tr>
	  <tr id="set-${L.poid}" style="display:none;">
       <td colspan="20" style="padding:0">
	    <span class="pull-right">
		 <p class="hidden">${L.chineseName}</p>
		 <p class="hidden">${L.englishName}</p>
		 <!--<a class="btn btn-default mt-10 mb-10 mr-5" name="ManageCoobjects.asp?PoID=1&h=" onclick= "getvalue(this.name)" onclick= "getvalue(this.name)">学位项目</a>-->
		 <a class="btn btn-default mt-10 mb-10 mr-5" name="managelink?poid=${L.poid}&amp;h=" onclick="getvalue(this.name)">人员管理</a>
         <a class="btn btn-default mt-10 mb-10 mr-5" data-toggle="modal" data-target="#myedit" onclick="editAddress(1,this)">编辑</a>
        </span></td>
      </tr>
     </c:forEach>
	 ...
	 <input name="aurl" type="hidden" value="http://aacsb.ustc.edu.cn/tjut/Position.asp">
	</form>
 </div>
</div>
<div class="modal fade" id="myadd" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
		    <form action="addPosition.do" method="post" name="addPosition">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h4 class="modal-title" id="myModalLabel">添加职务</h4>
            </div>
    ...
    <div class="controls">
     <div class="input-group">
	   <span class="input-group-addon" id="sizing-addon3"><div class="input-group-width80">中文名称</div></span>
		<input type="text" name="chineseName" class="form-control" placeholder="请输入职务中文名称" value="" required="">
	 </div>
	 <p class="help-block help-info"><font style="font-style:normal;font-size:13px;" color="red">*</font> 请输入职务中文名称</p>
	</div>
   </div>
   <div class="control-group">
    <div class="controls">
     <div class="input-group">
	   <span class="input-group-addon" id="sizing-addon3"><div class="input-group-width80">英文名称</div></span>
		<input type="text" name="englishName" class="form-control" placeholder="请输入职务英文名称" value="" required="">
	 </div>
	 <p class="help-block help-info"><font style="font-style:normal;font-size:13px;" color="red">*</font> 请输入职务英文名称</p>
	</div>
   </div>
   <div style="clear:both;"></div>
			</div>
            <div class="modal-footer">
                ...
                <input name="addPosition" type="submit" class="btn btn-primary" value="完成提交">
            </div>
            </form>
        </div>
    </div>
...
<div class="modal fade" id="myedit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="controls">
     <div class="input-group">
	   <span class="input-group-addon" id="sizing-addon3"><div class="input-group-width80">中文姓名</div></span>
		<input type="text" id="cname" name="ChineseName" class="form-control" placeholder="请输入职务中文名称" value="" required="">
	 </div>
	 <p class="help-block help-info"><font style="font-style:normal;font-size:13px;" color="red">*</font> 请输入职务中文名称</p>
	</div>
   </div>
   <div class="control-group">
    <div class="controls">
     <div class="input-group">
	   <span class="input-group-addon" id="sizing-addon3"><div class="input-group-width80">英文名称</div></span>
		<input type="text" id="ename" name="EnglishName" class="form-control" placeholder="请输入职务英文名称" value="" required="">
	 </div>
	 <p class="help-block help-info"><font style="font-style:normal;font-size:13px;" color="red">*</font> 请输入职务英文名称</p>
	</div>
   </div>
   <div style="clear:both;"></div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
				<input type="hidden" name="PoID" value="" id="rid">
...
<div class="container mt-40">
 <div class="alert alert-info alert-dismissable">
  ...
  提示：院内职务可对指定教师进行院内职务分配，认证教师是否具有行政职务最终将会在15-1表中职业责任栏目中显示出来；在本页中若进行职务和学位项目关联，该职务的人员会在相关学位项目信息中具有管理权限。
 </div>
</div> 
<!-- 分页功能 -->
...
<ul class='pagination'>
	...
	<c:if test="${ps.pageNum != 1}">
		<li><a href="position?page=${ps.pageNum-1}" aria-label="Previous"><span aria-hidden='true'>&laquo;</span></a></li>
	</c:if>
	<c:forEach begin="1" end="${ps.pages}" var="pageNumber">
		<c:if test="${pageNumber == ps.pageNum}">
			<li class="active"><a href="position?page=${pageNumber}">${pageNumber}</a></li>
		</c:if>
		<c:if test="${pageNumber != ps.pageNum}">
			<li><a href="position?page=${pageNumber}">${pageNumber}</a></li>
		</c:if>
	</c:forEach>
	...
	<c:if test="${ps.pageNum != ps.lastPage}">
		<li><a href="position?page=${ps.pageNum+1}" aria-label="Next"><span aria-hidden='true'>&raquo;</span></a></li>
	</c:if>
	</c:if>
</ul>
</nav>
...
<section>
 <div class="aacsb_footer">
	<p class="info">系统仅支持Chrome、Firefox、Edge等浏览器<br>Copyright © 2013-2021，&nbsp;<a href="https://aacsb.ustc.edu.cn/tjut/Copyright.asp">信息系统版权说明和技术支持</a>&nbsp; v3.0.200619, 页面执行时间：11.72毫秒
 </p></div>
</section>

<iframe name="Detail" id="Detail" frameborder="0" hspace="0" vspace="0" src="../../resources/admin/login/images/Record.html" style="display:none"></iframe>
