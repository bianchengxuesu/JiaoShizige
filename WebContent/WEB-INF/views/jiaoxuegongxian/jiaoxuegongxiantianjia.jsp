   ...
   <div class="control-group">
     ...
     <label for="name">选择课程<span style="color:#339900;font-size:80%" id="sayCO"><font style="color:#888;">(必选项)</font></span></label>
      ...
      $("#course").autocomplete({
   	   source:function(request, response){
   		   $.ajax({
   			   type:"post",
   			   url:"AutoCompleteCourse",//后端接受的路径
   			   async:false,//同步的方式
   			   dataType:"json",
   			   data:{
   			   ...
   			   success:function(data){
   				   response($.map(data,function(item){
   					   return {  //lable为下拉列表显示数据源。value为选中放入到文本框的值，这种方式可以自定义显示
   						   lable:item.course,  //固有属性
                              value:item.course, //选中后填充到下拉框的值
                              coid: item.course,  //自定义属性
                              conums:item.conums,
                              cochs:item.cochs,
                              cocredits:item.cocredits
   					   }
   				   }));
   			   }
   		   });
      ...
      <input id="course" name="course" class="form-control ui-autocomplete-input" placeholder="请输入关键字匹配并选择" type="text" required="" autocomplete="off">
      <input id="coid" type="hidden" name="CoID" value="">
	  </div>
    ...
    <div class="col-sm-4">
	 ...
	 <script>
      ...
      <input id="teacher" name="teacher" class="form-control ui-autocomplete-input" placeholder="请输入关键字匹配并选择" type="text" required="" autocomplete="off">
...
        }
      ...
      <input id="jiaomi" name="jiaomi" class="form-control ui-autocomplete-input" placeholder="请输入关键字匹配并选择" type="text" required="" autocomplete="off">
   ...
   <div class="control-group">
    <div class="row">
	 <div class="col-sm-4">
      ...
      <div class="">
		<input type="text" id="conums" name="conums" readonly="" class="form-control" value="">
     ...
     <div class="col-sm-4">
      ...
      <div class="">
		<input type="text" id="cochs" name="cochs" readonly="" class="form-control" value="">
	  </div>
      <p class="help-block help-info text-right"></p>
	 </div>
	 <div class="col-sm-4">
      ...
      <div class="">
		<input type="text" id="cocredits" name="cocredits" readonly="" class="form-control" value="">
	  </div>
      <p class="help-block help-info text-right"></p>
	 </div>
	</div>
    ...
    <div class="row">
     <div class="col-sm-4">
      ...
      <div class="dropdown bootstrap-select form-control bs3">
	   <div class="dropdown bootstrap-select form-control bs3 "><select id="coobjects"name="coobjects" class="selectpicker form-control" data-live-search="true" required="" tabindex="-98">
   ...
   <div class="control-group">
    <div class="row">
     <div class="col-sm-6">
      ...
      <div class="">
		<input type="text" name="coches" class="form-control" placeholder="请输入实际课时" value="" required="">
	  </div>
      <p class="help-block help-info text-right"></p>
	  </div>
	 <div class="col-sm-6">
      ...
      <div class="">
		<input type="text" name="ecochs" class="form-control" placeholder="请输入实验课时" value="">
	  </div>
      <p class="help-block help-info text-right"></p>
	 </div>
	</div>
   ...
   <div class="control-group">
    <div class="row">
     <div class="col-sm-6">
      ...
      <div class="">
		<input type="text" name="syear" class="form-control" placeholder="请输入开课学年" value="" required="">
	  </div>
      <p class="help-block help-info text-right"></p>
	  </div>
	 <div class="col-sm-6">
    ...
    <div class="row">
	 ...
	 <div class="col-sm-6">
      ...
      <div class="dropdown bootstrap-select show-tick form-control bs3">
       ...
       <option value="32">金融系001班</option>
   ...
   <div class="control-group">
    <label for="name">课程备注<span style="font-size:80%"><font style="color:#888;"></font></span></label>
     <div class="">
	  <textarea class="form-control" name="beizhu" style="width:100%;height:60px;"></textarea>
	 </div>
   ...
   <input name="action" type="Submit" id="submit" value="  确 认 添 加  " class="add-button btn-primary btn-lg mt-20">
   </div>
  </div>
  <!-- </form> -->
  <div class="col-md-3">
